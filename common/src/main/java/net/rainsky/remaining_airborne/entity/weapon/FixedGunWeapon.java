...
public class FixedGunWeapon extends BulletWeapon {
    ...
    public FixedGunWeapon(VehicleEntity entity, ItemStack stack, WeaponMount mount, int slot) {
        this(entity, stack, mount, slot, 4.0f, 0.1f);
    }

    public FixedGunWeapon(VehicleEntity entity, ItemStack stack, WeaponMount mount, int slot, float velocity, float inaccuracy) {
