...
public class BombPylonWeapon extends BulletWeapon {
    private static final float MAX_COOLDOWN = 1.0f;
    private float cooldown = 0.0f;

    public BombPylonWeapon(VehicleEntity entity, ItemStack stack, WeaponMount mount, int slot) {
    ...
    protected Vector4f getBarrelOffset() {
        return new Vector4f(0.0f, -1.5f, 0.0f, 1.0f);
    }
